            ...
            {freeDateRanges.map((range, index) => (
              ...
              >
                <div className="date-section">
                 ...
                 <span className="date-value">{new Date(range.startDate).toLocaleString('en-US', { timeZone: 'America/New_York' })}</span>
                </div>
                <div className="date-section">
                  <FaHome className="date-icon" />
                  <span className="date-label">Return:</span>
<span className="date-value">{new Date(range.endtDate).toLocaleString('en-US', { timeZone: 'America/New_York' })}</span>
